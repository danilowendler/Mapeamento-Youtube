...
export function UsageMeter({ usage }: { usage: Usage }) {
  ...
  return (
    <div className="flex items-center justify-between gap-xs rounded-md border border-hairline px-xs py-xxs">
      <span className="text-caption-upper uppercase tracking-widest text-muted-soft">
        Pesquisas no mês
      </span>
      <div className="flex items-center gap-xs">
        <div className="h-[3px] w-[120px] overflow-hidden rounded-full bg-canvas-elevated">
          <div
